...
CONTACT_TEXT = (
    ...
    "Напишите сообщение одним текстом. Администратор получит его в боте и сможет ответить вам здесь же."
)

SUPPORT_PROMPT_TEXT = (
    "✉️ Напишите ваш вопрос или комментарий одним сообщением.\n\n"
    "Например: нужные даты, адрес, вопрос по доставке или залогу. "
    "Администратор получит сообщение и ответит вам в этом чате."
)
